...
\label{sec:org433f3db}
\subsection{Lecture 0: Introduction}
\label{sec:orgd93e1b9}
\begin{enumerate}
...
\label{sec:orgc0ae194}
\subsubsection{Classical rigid rotor}
\label{sec:orgf3b76d7}
\begin{enumerate}
...
\label{sec:orgb1fde32}
\subsubsection{Schr\"{o}dinger equation}
\label{sec:org41ddc59}
\begin{enumerate}
...
\label{sec:orgcc5d466}
\subsubsection{Have to specify:}
\label{sec:orgb5b5d83}
\begin{enumerate}
...
\label{sec:org8799f8c}
\subsubsection{UV/visible spectroscopy}
\label{sec:orgec8e160}
\begin{enumerate}
...
\label{sec:org8da5070}
\subsubsection{Partition function}
\label{sec:org08cfe99}
\begin{enumerate}
...
\label{sec:org28ca8dd}
\subsubsection{Ideal gas of molecules}
\label{sec:org6bc7207}
\begin{displaymath}
...
\label{sec:orgedeee9d}
\subsubsection{Standard states}
\label{sec:orgea1f989}
\begin{enumerate}
