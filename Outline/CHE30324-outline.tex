...
\label{sec:org0d81797}
\subsection{Lecture 0: Introduction}
\label{sec:org55b3454}
\begin{enumerate}
...
\label{sec:org12e3f1b}
\subsubsection{Properties of waves}
\label{sec:orgca20139}
\begin{enumerate}
...
\label{sec:org5c01b88}
\subsubsection{Classical rigid rotor}
\label{sec:org63cc7f1}
\begin{enumerate}
...
\label{sec:org23b93f9}
\subsubsection{Schr\"{o}dinger equation}
\label{sec:org58cc660}
\begin{enumerate}
...
\label{sec:org064a61b}
\subsubsection{Have to specify:}
\label{sec:orgbd4e432}
\begin{enumerate}
...
\label{sec:org10cea47}
\begin{itemize}
\item UV/visible spectroscopy
\label{sec:org9b06e01}
\begin{enumerate}
...
\label{sec:org7f3b3da}
\subsubsection{Partition function}
\label{sec:orgfdb6886}
\begin{enumerate}
...
\label{sec:orgc840696}
\subsubsection{Ideal gas of molecules}
\label{sec:org9ea91f0}
\begin{displaymath}
...
\label{sec:orgdd0f055}
\subsubsection{Many-particle molecule}
\label{sec:org6109546}
\begin{enumerate}
...
\label{sec:org95ab40c}
\subsubsection{Thermodynamic connection}
\label{sec:org2e84ac9}
\begin{enumerate}
