...
\label{sec:org9ec9d4b}
\subsection{Lecture 0: Introduction}
\label{sec:org34b17ca}
\begin{enumerate}
...
\label{sec:orgd301b85}
\subsubsection{Classical rigid rotor}
\label{sec:org2c303d6}
\begin{enumerate}
...
\label{sec:orgc5f8006}
\subsubsection{Schr\"{o}dinger equation}
\label{sec:orga3cb9f7}
\begin{enumerate}
...
\label{sec:org80bd05e}
\subsubsection{Have to specify:}
\label{sec:org415cb8b}
\begin{enumerate}
...
\label{sec:orge0bc1cd}
\begin{itemize}
\item UV/visible spectroscopy
\label{sec:orga80eea4}
\begin{enumerate}
...
\label{sec:orgc95b594}
\subsubsection{Partition function}
\label{sec:org3fe7c5e}
\begin{enumerate}
...
\label{sec:org66b756f}
\subsubsection{Ideal gas of molecules}
\label{sec:orgb8aefac}
\begin{displaymath}
...
\label{sec:org4975643}
\subsubsection{Many-particle molecule}
\label{sec:org54bdc7e}
\begin{enumerate}
...
\begin{eqnarray*}
   r & = & k C_AC_B \\
     ...
     & = & \frac{k_B T}{h} \frac{q^\ddagger(T)}{q_A(T) q_B(T)}  e^{-{\Delta E(0)/k_BT}}
\end{eqnarray*}
\item application to atom - atom collision
\item application to two molecules
...
\label{sec:org682bff3}
\subsubsection{Thermodynamic connection}
\label{sec:orgfece8a3}
\begin{enumerate}
