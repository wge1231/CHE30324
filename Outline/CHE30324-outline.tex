...
\label{sec:org69f640d}
\subsection{Lecture 0: Introduction}
\label{sec:orgc2fd605}
\begin{enumerate}
...
\label{sec:org4fab685}
\subsubsection{Classical rigid rotor}
\label{sec:org329cf41}
\begin{enumerate}
...
\label{sec:org8099fc3}
\subsubsection{Schr\"{o}dinger equation}
\label{sec:org9683887}
\begin{enumerate}
