...
\label{sec:org7594cd8}
\subsection{Lecture 0: Introduction}
\label{sec:orgefaca06}
\begin{enumerate}
...
\label{sec:org2abf3e9}
\subsubsection{Classical rigid rotor}
\label{sec:org6994f81}
\begin{enumerate}
