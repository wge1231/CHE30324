...
\label{sec:org2f88407}
\subsection{Lecture 0: Introduction}
\label{sec:orge29b7fe}
\begin{enumerate}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.6\textwidth]{./Images/MaxwellBoltzmann.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.6\textwidth]{./Images/PlanckEnergy.pdf}
\caption{Planck oscillator energy \(\langle \epsilon \rangle_\lambda\) vs wavelength, normalized to \(k_B T\)}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.6\textwidth]{./Images/BlackBody.pdf}
