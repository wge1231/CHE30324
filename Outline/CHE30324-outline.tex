...
\label{sec:orgd0050a8}
\subsection{Lecture 0: Introduction}
\label{sec:org49047a8}
\begin{enumerate}
...
\item Photon energy related to frequency: $\backslash$(\(\epsilon\) = h \(\nu\)$\backslash$ = hc/\(\lambda\))
\item Light intensity related to number of photons
\end{enumerate}
\end{enumerate}
\subsubsection{Compton effect}
\label{sec:orgb253aa5}
\begin{enumerate}
\item light scattering off electrons changes \(\lambda\)
\item Demonstrates that photons carry momentum, \(p=h/\lambda\)
\end{enumerate}
\subsubsection{Wave-particle duality}
\label{sec:org043b4f3}
\subsubsection{Rutherford, planetary model of atom}
\label{sec:orgb85c291}
\begin{enumerate}
\item Inconsistent with Maxwell's equations
\end{enumerate}
\subsubsection{Bohr model of H atom}
\label{sec:org1f2036b}
\begin{enumerate}
...
\label{sec:org16b1a36}
\subsubsection{Classical rigid rotor}
\label{sec:org06e7b85}
\begin{enumerate}
...
\label{sec:org286903d}
\subsubsection{Partition function}
\label{sec:org56e5e9c}
\begin{enumerate}
...
\label{sec:orgaa95a34}
\subsubsection{Ideal gas of molecules}
\label{sec:org680d189}
\begin{displaymath}
...
\label{sec:orgbdf60e3}
\subsubsection{Standard states}
\label{sec:orga071083}
\begin{enumerate}
