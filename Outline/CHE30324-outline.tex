...
\label{sec:org06edfa0}
\subsection{Lecture 0: Introduction}
\label{sec:org3bb8157}
\begin{enumerate}
...
\label{sec:org3a01bbb}
\subsubsection{Classical rigid rotor}
\label{sec:org75c37aa}
\begin{enumerate}
...
\label{sec:org7c17319}
\subsubsection{Schr\"{o}dinger equation}
\label{sec:org673d73c}
\begin{enumerate}
...
\label{sec:org47c1177}
\subsubsection{Have to specify:}
\label{sec:org9f6a815}
\begin{enumerate}
...
\label{sec:org1e72626}
\begin{enumerate}
\item Each subsystem has energy \(U_i\) and degeneracy \(\Omega_i(U_i)\)
\item Bring in thermal contact, \(U=U_1+U_2\), \(\Omega=\Sum_{U_1}\Omega_1(U_1)\Omega_2(U_2)\)
\item If systems are very large, one combination of \(U_1\), \(U_2\) and \(\Omega\) will dominate sum
...
\label{sec:org9b914dd}
\subsubsection{Partition function}
\label{sec:orgc5447e0}
\begin{enumerate}
...
\label{sec:orga9a8d97}
\subsubsection{Ideal gas of molecules}
\label{sec:org7d71d50}
\begin{displaymath}
...
\label{sec:org619ee31}
\subsubsection{Standard states}
\label{sec:org3c2dd3c}
\begin{enumerate}
