...
\label{sec:org50d52d7}
\subsection{Lecture 0: Introduction}
\label{sec:org86e4acf}
\begin{enumerate}
...
\label{sec:org32e5bfd}
\subsubsection{Classical rigid rotor}
\label{sec:orgde92871}
\begin{enumerate}
...
\label{sec:org7b4195f}
\subsubsection{Partition function}
\label{sec:orgf5552c2}
\begin{enumerate}
...
\label{sec:org1898dc4}
\subsubsection{Ideal gas of molecules}
\label{sec:orgc32f2fb}
\begin{displaymath}
...
\label{sec:orgb1979e3}
\subsubsection{Standard states}
\label{sec:org93d943b}
\begin{enumerate}
