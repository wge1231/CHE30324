...
\label{sec:orgba9c78b}
\subsection{Lecture 0: Introduction}
\label{sec:orgc5f30d0}
\begin{enumerate}
...
\label{sec:orgeb0f614}
\subsubsection{Classical rigid rotor}
\label{sec:org292897a}
\begin{enumerate}
...
\label{sec:orgc362a68}
\subsubsection{Partition function}
\label{sec:org1ae04e1}
\begin{enumerate}
...
\label{sec:org91d4afa}
\subsubsection{Ideal gas of molecules}
\label{sec:orge272b32}
\begin{displaymath}
...
\label{sec:org11dd278}
\subsubsection{Standard states}
\label{sec:org632ce69}
\begin{enumerate}
