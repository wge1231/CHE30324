...
\label{sec:orge73d7bd}
\subsection{Lecture 0: Introduction}
\label{sec:org718d82d}
\begin{enumerate}
...
\label{sec:orgd2dbb62}
\subsubsection{Classical rigid rotor}
\label{sec:org685109b}
\begin{enumerate}
...
\label{sec:org0b023e3}
\subsubsection{Schr\"{o}dinger equation}
\label{sec:org1316680}
\begin{enumerate}
...
\label{sec:org916dd45}
\subsubsection{Have to specify:}
\label{sec:org70e3adc}
\begin{enumerate}
...
\label{sec:org51cc592}
\begin{itemize}
\item UV/visible spectroscopy
\label{sec:org9b8102d}
\begin{enumerate}
...
\label{sec:orgede667f}
\subsubsection{Partition function}
\label{sec:orgb0cbf59}
\begin{enumerate}
...
\label{sec:orga3b1a60}
\subsubsection{Ideal gas of molecules}
\label{sec:org5cce32e}
\begin{displaymath}
...
\label{sec:org0f68b0e}

\subsubsection{Many-particle molecule}
\label{sec:org5fd76ce}
\begin{enumerate}
...
\label{sec:orgf21d85f}
\begin{enumerate}
\item Consider \ce{A -> B}, eg vinyl alcohol to acetaldehyde (\ce{(HO)HC=CH2 -> CH3CHO})
\item Standard reaction entropy \(\Delta S^\circ (T) =  S^\circ_\mathrm{B}(T)-S^\circ_\mathrm{A}(T)\)
...
\Delta U^\circ (T) = U^\circ_\mathrm{B}(T)-U^\circ_\mathrm{A}(T)+\Delta E(0)
   \end{displaymath}
\item Standard reaction free energy
\end{enumerate}
\subsubsection{Chemical equilibrium}
\label{sec:org57a47ef}
\begin{enumerate}
\item Consider \ce{A <=> B}, eg vinyl alcohol to acetaldehyde
...
\begin{table}
   \caption{Vinyl alchohol to acetaldehyde standard state thermodynamcs}
\begin{tabular}{cc}
\includegraphics[scale=0.5]{./Images/rxn-entropy.png} & \includegraphics[scale=0.5]{./Images/rxn-energy.png}% \\
%\includegraphics[scale=0.5]{Images/2state-helmholtz.png} & \includegraphics[scale=0.5]{Images/2state-internal.png} \\
%\includegraphics[scale=0.5]{Images/2state-heatcapacity.png} & \includegraphics[scale=0.5]{Images/2state-entropy.png}
\end{tabular}
\end{table}
