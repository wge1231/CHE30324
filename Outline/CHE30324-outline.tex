...
\label{sec:org273a9cd}
\subsection{Lecture 0: Introduction}
\label{sec:org845dbf0}
\begin{enumerate}
...
\label{sec:org533b4f1}
\subsubsection{Classical rigid rotor}
\label{sec:org3336c31}
\begin{enumerate}
...
\label{sec:org82d0a3e}
\subsubsection{Partition function}
\label{sec:orgc2afa66}
\begin{enumerate}
...
\label{sec:org8403991}
\subsubsection{Ideal gas of molecules}
\label{sec:org682adaa}
\begin{displaymath}
...
\label{sec:org9420fcd}
\subsubsection{Standard states}
\label{sec:org89c12ab}
\begin{enumerate}
