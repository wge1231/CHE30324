...
\label{sec:orgd737a84}
\subsection{Lecture 0: Introduction}
\label{sec:org058aa25}
\begin{enumerate}
...
\label{sec:orga52af7e}
\subsubsection{Classical rigid rotor}
\label{sec:orgd5949a9}
\begin{enumerate}
