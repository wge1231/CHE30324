...
\label{sec:org714071b}
\subsection{Lecture 0: Introduction}
\label{sec:orgcdf9918}
\begin{enumerate}
...
\label{sec:org2b15ed8}
\subsubsection{Classical rigid rotor}
\label{sec:orgfcaefd9}
\begin{enumerate}
