...
\label{sec:org222a49b}
\subsection{Lecture 0: Introduction}
\label{sec:org920e335}
\begin{enumerate}
...
\label{sec:orgefb177c}
\subsubsection{Have to specify:}
\label{sec:org3967712}
\begin{enumerate}
...
\label{sec:orgd580ca0}
\begin{itemize}
\item UV/visible spectroscopy
\label{sec:org4c1714b}
\begin{enumerate}
...
\label{sec:orgf7072fd}
\subsubsection{Ideal gas of molecules}
\label{sec:org54c3252}
\begin{displaymath}
...
\label{sec:org46aa598}
\subsubsection{Many-particle molecule}
\label{sec:orge70ab82}
\begin{enumerate}
