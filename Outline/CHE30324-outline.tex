...
\label{sec:org5d4f972}
\subsection{Lecture 0: Introduction}
\label{sec:orgdff3b39}
\begin{enumerate}
...
\label{sec:orgba19f42}
\subsubsection{Classical rigid rotor}
\label{sec:orga25e0df}
\begin{enumerate}
