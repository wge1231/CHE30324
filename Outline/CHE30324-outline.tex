...
\label{sec:org8bbfc82}
\subsection{Lecture 0: Introduction}
\label{sec:orge798bcc}
\begin{enumerate}
...
\label{sec:org6e7040e}
\subsubsection{Classical rigid rotor}
\label{sec:org57d658d}
\begin{enumerate}
...
\label{sec:org3bdb60b}
\subsubsection{Partition function}
\label{sec:org2e1ae6b}
\begin{enumerate}
...
\label{sec:org6c7713d}
\subsubsection{Ideal gas of molecules}
\label{sec:org0d2080e}
\begin{displaymath}
...
\label{sec:org5cd4f60}
\subsubsection{Standard states}
\label{sec:org8a98565}
\begin{enumerate}
