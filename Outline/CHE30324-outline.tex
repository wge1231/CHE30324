...
\label{sec:org01eb346}
\subsection{Lecture 0: Introduction}
\label{sec:org1b1418b}
\begin{enumerate}
...
\label{sec:org0fdb17f}
\begin{enumerate}
\item wavefunction \(\psi(x)\) is a probability amplitude
\item wavefunction squared \(|\psi(s)|^2\) is probability density
\end{enumerate}
\subsubsection{Postulates}
\label{sec:orgd0fe36c}
\begin{enumerate}
...
\label{sec:org7f676da}
\subsubsection{Classical rigid rotor}
\label{sec:orge5e2970}
\begin{enumerate}
...
\label{sec:orgd41008a}
\subsubsection{Partition function}
\label{sec:orgad7988c}
\begin{enumerate}
...
\label{sec:orgff5cc7d}
\subsubsection{Ideal gas of molecules}
\label{sec:org253a618}
\begin{displaymath}
...
\label{sec:orga12d193}
\subsubsection{Standard states}
\label{sec:org295312d}
\begin{enumerate}
