...
\label{sec:orgbf35a66}
\subsection{Lecture 0: Introduction}
\label{sec:org9dc482e}
\begin{enumerate}
...
\label{sec:org445531c}
\subsubsection{Classical rigid rotor}
\label{sec:orge44bf2e}
\begin{enumerate}
...
\end{enumerate}
\end{enumerate}
\subsubsection{The H\"{u}ckel/tight binding model}
\label{sec:org809d312}
\begin{enumerate}
...
\end{enumerate}
\item Plot total energy vs.$\backslash$ internal coordinates: potential energy surface (PES)
