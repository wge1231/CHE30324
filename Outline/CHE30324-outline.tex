...
\label{sec:org7037c3a}
\subsection{Lecture 0: Introduction}
\label{sec:orgc2e6465}
\begin{enumerate}
...
\label{sec:orgf674bb8}
\subsubsection{Classical rigid rotor}
\label{sec:orgdf0a9a7}
\begin{enumerate}
...
\label{sec:org23ef4bf}
\subsubsection{Schr\"{o}dinger equation}
\label{sec:org57688bc}
\begin{enumerate}
...
\label{sec:orgeeaef03}
\subsubsection{Have to specify:}
\label{sec:orgae963ec}
\begin{enumerate}
...
\label{sec:org99d5d2f}
\begin{itemize}
\item UV/visible spectroscopy
\label{sec:org2630673}
\begin{enumerate}
...
\label{sec:org2cbc91c}
\subsubsection{Partition function}
\label{sec:orge0e4e6e}
\begin{enumerate}
...
\label{sec:org5f93df8}
\subsubsection{Ideal gas of molecules}
\label{sec:orgd89bfad}
\begin{displaymath}
...
\label{sec:orgddfdbd7}
\subsubsection{Many-particle molecule}
\label{sec:org84afc4f}
\begin{enumerate}
...
\label{sec:org652254b}
\subsubsection{Thermodynamic connection}
\label{sec:org0e7716d}
\begin{enumerate}
