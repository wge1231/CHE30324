...
\label{sec:orgf8e2d38}
\subsection{Lecture 0: Introduction}
\label{sec:org7dbe39c}
\begin{enumerate}
...
\label{sec:org8fbbd51}
\subsubsection{Classical rigid rotor}
\label{sec:orga85c631}
\begin{enumerate}
...
\label{sec:orge9435c7}
\subsubsection{Schr\"{o}dinger equation}
\label{sec:org9c311f5}
\begin{enumerate}
...
\label{sec:orgaa24cd3}
\subsubsection{Have to specify:}
\label{sec:orgc09d5cf}
\begin{enumerate}
...
\label{sec:org19bb8c2}
\begin{itemize}
\item UV/visible spectroscopy
\label{sec:org0191eda}
\begin{enumerate}
...
\label{sec:orgb20b135}
\subsubsection{Partition function}
\label{sec:orge98c1e9}
\begin{enumerate}
...
\label{sec:org663914b}
\subsubsection{Ideal gas of molecules}
\label{sec:org987eb8f}
\begin{displaymath}
...
\label{sec:org2b050e4}

\subsubsection{Many-particle molecule}
\label{sec:org1571ea3}
\begin{enumerate}
