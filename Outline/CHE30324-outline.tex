...
\label{sec:org4057015}
\subsection{Lecture 0: Introduction}
\label{sec:orgdf906c0}
\begin{enumerate}
...
\label{sec:org9a4b9c7}
\subsubsection{Classical rigid rotor}
\label{sec:org76c096b}
\begin{enumerate}
