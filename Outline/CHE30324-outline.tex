...
\label{sec:org114cbc5}
\subsection{Lecture 0: Introduction}
\label{sec:org1cff56d}
\begin{enumerate}
...
\label{sec:org8eb8815}
\subsubsection{Classical rigid rotor}
\label{sec:org58f69ac}
\begin{enumerate}
...
\label{sec:org19aad98}
\subsubsection{Partition function}
\label{sec:org40e53fe}
\begin{enumerate}
...
\label{sec:org138da74}
\subsubsection{Ideal gas of molecules}
\label{sec:org06b5db0}
\begin{displaymath}
...
\label{sec:orgc3960a5}
\subsubsection{Standard states}
\label{sec:org25d0aac}
\begin{enumerate}
