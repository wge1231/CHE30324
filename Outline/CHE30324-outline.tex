...
\label{sec:org2ec2b89}
\subsection{Lecture 0: Introduction}
\label{sec:org156e023}
\begin{enumerate}
...
\label{sec:org1095e2b}
\subsubsection{Classical rigid rotor}
\label{sec:orgf867af7}
\begin{enumerate}
...
\label{sec:org21d0ebe}
\subsubsection{Partition function}
\label{sec:org2c92811}
\begin{enumerate}
...
\begin{center}
\includegraphics[width=.9\linewidth]{./Images/2state-partition.png}
\end{center}
\begin{center}
\includegraphics[width=.9\linewidth]{./Images/2state-probability.png}
\end{center}
\begin{center}
\includegraphics[width=.9\linewidth]{./Images/2state-helmholtz.png}
\end{center}
\begin{center}
\includegraphics[width=.9\linewidth]{./Images/2state-internal.png}
\end{center}
\begin{center}
\includegraphics[width=.9\linewidth]{./Images/2state-heatcapacity.png}
\end{center}
\begin{center}
\includegraphics[width=.9\linewidth]{./Images/2state-entropy.png}
\end{center}

\subsubsection{Thermodynamic functions in canonical ensemble}
\label{sec:orgabe5f37}
...
\label{sec:org5890590}
\subsubsection{Ideal gas of molecules}
\label{sec:org73eaf31}
\begin{displaymath}
