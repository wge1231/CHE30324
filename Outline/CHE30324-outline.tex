...
\label{sec:org3a4327c}
\subsection{Lecture 0: Introduction}
\label{sec:orgb718a36}
\begin{enumerate}
...
\label{sec:org544dff0}
\subsubsection{Classical rigid rotor}
\label{sec:org6673da9}
\begin{enumerate}
