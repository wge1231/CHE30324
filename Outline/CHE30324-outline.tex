...
\label{sec:orge1c8d22}
\subsection{Lecture 0: Introduction}
\label{sec:orgd4ab30f}
\begin{enumerate}
...
\label{sec:org9b1a94a}
\subsubsection{Classical rigid rotor}
\label{sec:org56d147d}
\begin{enumerate}
...
\label{sec:org7d0b4d2}
\subsubsection{Vibrational transitions}
\label{sec:org28c6a27}
\begin{enumerate}
