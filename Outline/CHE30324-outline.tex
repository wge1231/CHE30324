...
\label{sec:orgc96b2c0}
\subsection{Lecture 0: Introduction}
\label{sec:org225d604}
\begin{enumerate}
...
\label{sec:org62b36d0}
\subsubsection{Classical rigid rotor}
\label{sec:orgc899e2b}
\begin{enumerate}
...
\label{sec:orga826624}
\subsubsection{Schr\"{o}dinger equation}
\label{sec:org3a62968}
\begin{enumerate}
...
\label{sec:org465c41f}
\subsubsection{Have to specify:}
\label{sec:org0f958f5}
\begin{enumerate}
...
\label{sec:org67bb3d4}
\begin{itemize}
\item UV/visible spectroscopy
\label{sec:orgf407345}
\begin{enumerate}
...
\label{sec:org02ac107}
\subsubsection{Ideal gas of molecules}
\label{sec:org6b7c241}
\begin{displaymath}
...
\label{sec:orgd4c79a7}
\subsubsection{Many-particle molecule}
\label{sec:orgcf81b2d}
\begin{enumerate}
...
\item Equilibrium composition starting from \ce{C2H6}
