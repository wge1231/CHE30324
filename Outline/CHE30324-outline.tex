...
\label{sec:org70b2b0b}
\subsection{Lecture 0: Introduction}
\label{sec:orgca028e9}
\begin{enumerate}
...
\label{sec:org47d4674}
\subsubsection{Classical rigid rotor}
\label{sec:orge6e137b}
\begin{enumerate}
...
\label{sec:org7319a06}
\subsubsection{Partition function}
\label{sec:orgf4733cc}
\begin{enumerate}
...
\label{sec:orgf003923}
\subsubsection{Ideal gas of molecules}
\label{sec:orgb97c626}
\begin{displaymath}
...
\label{sec:orga6e43b7}
\subsubsection{Standard states}
\label{sec:org1e98270}
\begin{enumerate}
