...
\label{sec:orgbb7a029}
\subsection{Lecture 0: Introduction}
\label{sec:orgb72925c}
\begin{enumerate}
...
\label{sec:orgf756f1c}
\subsubsection{Classical rigid rotor}
\label{sec:org1ebf279}
\begin{enumerate}
...
\label{sec:org05416ee}
\subsubsection{Schr\"{o}dinger equation}
\label{sec:orgfa691a5}
\begin{enumerate}
