...
\label{sec:org83f9bf8}
\subsection{Lecture 0: Introduction}
\label{sec:org5a7d6cb}
\begin{enumerate}
...
\label{sec:orgfb41b25}
\subsubsection{Classical rigid rotor}
\label{sec:org2bdfaa5}
\begin{enumerate}
...
\label{sec:org0844841}
\subsubsection{Schr\"{o}dinger equation}
\label{sec:org43d9d8d}
\begin{enumerate}
...
\label{sec:orgb62755f}
\subsubsection{Qualtitative bonding}
\label{sec:org9bcc0d5}
\begin{enumerate}
...
\label{sec:org901648b}
\subsubsection{Have to specify:}
\label{sec:org89a2ffd}
\begin{enumerate}
...
\label{sec:orgce4124c}
\subsubsection{Partition function}
\label{sec:org200e7ca}
\begin{enumerate}
...
\label{sec:org3dc16bc}
\subsubsection{Ideal gas of molecules}
\label{sec:org9d24924}
\begin{displaymath}
...
\label{sec:org6a778f5}
\subsubsection{Many-particle molecule}
\label{sec:orga8cd743}
\begin{enumerate}
...
\label{sec:org81a5a95}
\subsubsection{Thermodynamic connection}
\label{sec:org9f31bfc}
\begin{enumerate}
