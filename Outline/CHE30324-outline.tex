...
\label{sec:org8b3ca41}
\subsection{Lecture 0: Introduction}
\label{sec:org1f73614}
\begin{enumerate}
...
\label{sec:org53d91bf}
\subsubsection{Classical rigid rotor}
\label{sec:orgadeaacd}
\begin{enumerate}
...
\label{sec:org6cc4867}
\subsubsection{Partition function}
\label{sec:orgf4ed5ce}
\begin{enumerate}
...
\label{sec:orgb93e13c}
\subsubsection{Ideal gas of molecules}
\label{sec:org65cfdca}
\begin{displaymath}
...
\label{sec:orgdb497f2}
\subsubsection{Standard states}
\label{sec:org8e38449}
\begin{enumerate}
