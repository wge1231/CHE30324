...
\label{sec:org069d3ac}
\subsection{Lecture 0: Introduction}
\label{sec:org3e8224d}
\begin{enumerate}
...
\label{sec:orga9ccd7c}
\subsubsection{Classical rigid rotor}
\label{sec:orgec768d3}
\begin{enumerate}
...
\label{sec:org25b8279}
\subsubsection{Partition function}
\label{sec:org36e451a}
\begin{enumerate}
...
\label{sec:orgfa3532a}
\subsubsection{Ideal gas of molecules}
\label{sec:orgf496ce2}
\begin{displaymath}
...
\label{sec:org53ea780}
\subsubsection{Standard states}
\label{sec:orgea6448c}
\begin{enumerate}
