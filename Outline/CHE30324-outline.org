...
1. True wavefunction energy is lower bound on energy of any trial wavefunction
2. Because true solutions form a complete set
3. Use to optimize candidate wavefunctions (give an example?)
...
*** Herman-Skillman code for DFT calculations on atoms
